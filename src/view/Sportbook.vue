...
export default {
    ...
    mounted(){
        this.Getsportbook();
        this.getBennersportbook();
    },
    methods: {
        //=====getBennersportbook=========
        getBennersportbook(){
            axios.get("https://admin.kh.2m-sport.com/api/bennersportbook").then((res)=>{
                this.Bennersportbook = res.data.data;
        ...
        //=====Getsportbook=========
        Getsportbook(){
        axios.get("https://admin.kh.2m-sport.com/api/sportbook").then((res)=>{
            this.sportbook = res.data.data;
        }).catch(function (error) {
            console.error(error);
        });
        },
...
<!-- <div v-for="(value, key, index) in Bennersportbook" :key="index">
...
<div class="mt-2"></div>
        <div class="grid-footer game-list" data-aos="zoom-in">
            ...
            <div v-for="(value, key, index) in sportbook" :key="index">
